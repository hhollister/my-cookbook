    ...
    <body>
        ...
        <div class="container theme-showcase" role="main">
            ...
            <div class="row">
                ...
                <form class="form-signin">
                    <label for="sundayMeal" class="sr-only">Sunday Meal</label>
                    <input type="text" id="sundayMeal" class="form-control" placeholder="Sunday Meal" autofocus>
                    <label for="mondayMeal" class="sr-only">Monday Meal</label>
                    <input type="text" id="mondayMeal" class="form-control" placeholder="Monday Meal" >
                    <label for="TuesdayMeal" class="sr-only">Tuesday Meal</label>
                    <input type="text" id="TuesdayMeal" class="form-control" placeholder="Tuesday Meal" >
                    <label for="wednesdayMeal" class="sr-only">Wednesday Meal</label>
                    ...
                    <button class="btn btn-lg btn-primary btn-block" type="submit">Add Sunday Meal</button>
